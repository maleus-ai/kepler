...
| `Inspect`         | `config_path`, `services[]`, `include_services`, `include_environment`, `include_flags`                               | Inspect config and runtime state (JSON output). Sections gated by `inspect:services`, `inspect:environment`, `inspect:flags` sub-rights                                                                  |
